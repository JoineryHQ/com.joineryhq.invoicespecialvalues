 ...
 */
class CRM_Invoicespecialvalues_Upgrader_Base {

  /**
   * @var CRM_Invoicespecialvalues_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Invoicespecialvalues_Upgrader(
        'com.joineryhq.invoicespecialvalues',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Invoicespecialvalues_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Invoicespecialvalues_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
