 ...
 */
class CRM_Invoicespecialvalues_Upgrader extends CRM_Invoicespecialvalues_Upgrader_Base {
  ...
  public function install() {
    ...
    $createOptionGroup = \Civi\Api4\OptionGroup::create()
  ...
  /**
   * Create option group for saving display_on_invoices values
   *
   * @return TRUE on success
   * @throws Exception
   */
  public function upgrade_1001() {
    $this->ctx->log->info('Applying update 1001 (Create option group for saving display_on_invoices values)');
